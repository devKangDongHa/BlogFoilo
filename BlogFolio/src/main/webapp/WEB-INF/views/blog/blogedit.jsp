...
<script type="text/javascript">
	...
	$(function(){
			...
			var num = "${boardview.num}";
			var title = "${boardview.title}";
			var content = "${boardview.content}";
			var subcontent = "${boardview.subcontent}";
			var category_number = "${boardview.category_number}";
			var category_snumber = "${boardview.category_snumber}";
			var thumbnail = "${boardview.thumbnail}";
			...
			$("#category_snumber").val(category_snumber);		
			$("#wirtethumbnail").val(thumbnail);
		...
		$("#btnWrite").click(function(){
			...
			frm.method = "POST";
			frm.action = "<%=ctxPath%>/Blog/WriteEditEnd.com";
